    ...
    <div class="page page1 flex-cen">
      ...
      <div class="con">
          <transition name="top-bottom">
            <div class="h2 flex-cen" v-show="showHide"><img src="../../assets/images/changshun/page59_1.png" alt="" /></div>
          </transition>
          <div class="con-one flex-cen">
                <div class="left">
                    <transition name="left-right" class="dl" v-show="showHide">
                        <img src="../../assets/images/changshun/page59_2.png" alt="" v-show="showHide">              
                    </transition>
                </div>
                <div class="right">
                    <transition name="right-left">
                      <img src="../../assets/images/changshun/page59_3.png" alt="" v-show="showHide">               
                    </transition>
                </div>
          </div> 
...
<style scoped>
  ...
  .h2{width:683px;height: 168px;position: relative;margin-left: 1122px;}
  .h3{margin-top:137px;}
  ...
  .left{width:1433px;position: relative;;margin-right: 60px;}
  /* .right{width:1390px;} */
  .left,.right{margin-top: 89px;}
</style>