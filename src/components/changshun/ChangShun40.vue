    ...
    <div class="page page1 flex-cen">
      ...
      <div class="con">
          <transition name="top-bottom">
            <div class="h2 flex-cen" v-show="showHide"><img src="../../assets/images/changshun/page40_1.png" alt="" /></div>
          </transition>
          <div class="con-one flex-cen">
                <div class="left">
                    <transition name="left-right" class="dl" v-show="showHide">
                        <img src="../../assets/images/changshun/page40_2.png" alt="" v-show="showHide">              
                    </transition>
                </div>
                <div class="right">
                    <transition name="right-left">
                      <img src="../../assets/images/changshun/page40_3.png" alt="" v-show="showHide">               
                    </transition>
                </div>
          </div> 
...
<style scoped>
  ...
  .h2{width:888px;height: 170px;position: relative;margin-left: 708px;}
  .h3{margin-top:137px;}
  ...
  .left{width:1124px;position: relative;;margin-right: 56px;}
  /* .right{width:1390px;} */
  .left,.right{margin-top: 83px;}
</style>