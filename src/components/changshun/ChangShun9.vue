        ...
        <div class="con">
          <transition name="top-bottom">
            <div class="h2 flex-cen" v-show="showHide">
              <img src="../../assets/images/changshun/page99_01.png" alt="" />
            </div>
          </transition>
          <div class="con-one flex-cen">
            <div class="left">
              <transition name="left-right">
                <img
                  src="../../assets/images/changshun/page99_02.png"
                  alt=""
                  v-show="showHide"
                />
              </transition>
            ...
            <div class="right">
              <transition name="right-left">
                <img
                  src="../../assets/images/changshun/page99_03.png"
                  alt=""
                  v-show="showHide"
                />
              </transition>
...
<style scoped>
  ...
  .left{width:1359px;position: relative;;margin-right: 62px;}
  .right{width:1359px;}
