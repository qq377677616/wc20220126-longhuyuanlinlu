    ...
    <div class="page page1 flex-cen">
      ...
      <div class="con">
          <transition name="top-bottom">
            <div class="h2 flex-cen" v-show="showHide"><img src="../../assets/images/changshun/page25_1.png" alt="" /></div>
          </transition>
          <div class="con-one flex-cen">
                <div class="left">
                    <transition name="left-right">
                      <img src="../../assets/images/changshun/page25_2.png" alt="" v-show="showHide">              
                    </transition>
                </div>
                <div class="right">
                    <transition name="right-left">
                      <img src="../../assets/images/changshun/page25_3.png" alt="" v-show="showHide">               
                    </transition>
                </div>
          </div> 
          <transition name="bottom-top">
              <img src="../../assets/images/changshun/page25_4.png" alt="" v-show="showHide" class="bottom">               
          </transition>
      </div>
        </transition>
    </div>
...
<style scoped>
  ...
  .h2{width:888px;height: 170px;position: relative;margin-left: 1018px;}
  .h3{margin-top:137px;}
  ...
  .left{width:1359px;position: relative;;margin-right: 85px;}
  .right{width:1359px;}
  .left,.right{margin-top: 147px;}
  .bottom{margin-top: 40px;margin-left: 763px;}
</style>