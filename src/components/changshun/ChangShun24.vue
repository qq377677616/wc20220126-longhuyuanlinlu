    ...
    <div class="page page1 flex-cen">
      ...
      <div class="con">
          <!-- <transition name="top-bottom">
            <div class="h2 flex-cen" v-show="showHide"><img src="../../assets/images/changshun/page23_1.png" alt="" /></div>
          </transition> -->
          <div class="con-one flex-cen">
                <div class="left">
                    <transition name="left-right">
                      <img src="../../assets/images/changshun/page24_2.png" alt="" v-show="showHide">              
                    </transition>
                </div>
                <div class="right">
                    <transition name="right-left">
                      <img src="../../assets/images/changshun/page24_1.png" alt="" v-show="showHide">               
                    </transition>
                </div>
          </div> 
      </div>
...
<style scoped>
  ...
  .h2{width:2768px;height: 447px;position: relative;}
  .h3{margin-top:137px;}
  ...
  .left{width:1580px;position: relative;;margin-right: 85px;}
  .right{width:1280px;}
  .left,.right{margin-top: 56px;}
</style>