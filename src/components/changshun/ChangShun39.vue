          ...
          <div class="con-one flex-cen">
                <div class="left">
                    <transition name="left-right">
                      <img src="../../assets/images/changshun/page39_1.png" alt="" v-show="showHide">              
                    </transition>
                </div>
                <div class="right">
                    <transition name="right-left">
                      <img src="../../assets/images/changshun/page39_2.png" alt="" v-show="showHide">               
                    </transition>
                </div>
          </div> 
      </div>
...
<style scoped>
  ...
  .left{width:1231px;position: relative;;margin-right: 66px;}
  .right{width:1548px;}
</style>