        ...
        <div class="con">
          <transition name="top-bottom">
            <div class="h2 flex-cen" v-show="showHide">
              <img src="../../assets/images/changshun/page11_1.png" alt="" />
            </div>
          </transition>
          <div class="con-one flex-cen">
            <div class="left">
              <transition name="left-right">
                <img
                  src="../../assets/images/changshun/page11_2.png"
                  alt=""
                  v-show="showHide"
                />
              </transition>
            ...
            <div class="right">
              <transition name="right-left">
                <img
                  src="../../assets/images/changshun/page11_3.png"
                  alt=""
                  v-show="showHide"
                />
              </transition>
...
<style scoped>
  ...
  .h2{width:2792px;height: 223px;position: relative;}
  .h2 img{
    width: 1493px;height: 223px;
  }
  .h3{margin-top:137px;}
  ...
  .left{width:1430px;position: relative;margin-right: 62px;}
  .right{width:1430px;}
  .left,.right{margin-top: 51px;}
</style>