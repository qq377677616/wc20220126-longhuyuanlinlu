          ...
          <div class="con-one flex-cen">
                <div class="left">
                    <transition name="left-right">
                      <img src="../../assets/images/changshun/page45_1.png" alt="" v-show="showHide">              
                    </transition>
                </div>
                <div class="right">
                    <transition name="right-left">
                      <img src="../../assets/images/changshun/page45_2.png" alt="" v-show="showHide">               
                    </transition>
                </div>
          </div> 
      </div>
...
<style scoped>
  ...
  .left{width:1034px;position: relative;;margin-right: 75px;}
  .right{width:1304px;}
</style>