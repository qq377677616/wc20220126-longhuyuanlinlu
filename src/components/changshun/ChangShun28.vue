    ...
    <div class="page page1 flex-cen">
      ...
      <div class="con">
          <transition name="top-bottom">
            <div class="h2 flex-cen" v-show="showHide"><img src="../../assets/images/changshun/page28_1.png" alt="" /></div>
          </transition>
          <transition name="top-bottom">
              <img src="../../assets/images/changshun/page28_2.png" alt="" v-show="showHide" class="bottom">               
          </transition>
          <div class="con-one flex-cen">
                <div class="left">
                    <transition name="left-right">
                      <img src="../../assets/images/changshun/page28_3.png" alt="" v-show="showHide">              
                    </transition>
                </div>
                <div class="right">
                    <transition name="right-left">
                      <img src="../../assets/images/changshun/page28_4.png" alt="" v-show="showHide">               
                    </transition>
                </div>
          </div> 
...
<style scoped>
  ...
  .left{width:1390px;position: relative;;margin-right: 10px;}
  .right{width:1390px;}
  .left,.right{margin-top: 32px;}
