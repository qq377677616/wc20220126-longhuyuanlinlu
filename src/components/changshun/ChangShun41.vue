    ...
    <div class="page page1 flex-cen">
      ...
      <div class="con">
          <transition name="top-bottom">
            <div class="h2 flex-cen" v-show="showHide"><img src="../../assets/images/changshun/page41_1.png" alt="" /></div>
          </transition>
          <div class="con-one flex-cen">
                <div class="left">
                    <transition name="left-right">
                      <img src="../../assets/images/changshun/page41_2.png" alt="" v-show="showHide">              
                    </transition>
                </div>
                <div class="right">
                    <transition name="right-left">
                      <img src="../../assets/images/changshun/page41_3.png" alt="" v-show="showHide">               
                    </transition>
                </div>
          </div> 
      </div>
...
<style scoped>
  ...
  .h2{width:2676px;height: 451px;position: relative;}
  .h3{margin-top:137px;}
  ...
  .left{width:1372px;position: relative;;margin-right: 48px;}
  .right{width:1372px;}
  .left,.right{margin-top: 125px;}
</style>