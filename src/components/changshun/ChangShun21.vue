        ...
        <div class="con">
          <transition name="top-bottom">
            <div class="h2 flex-cen" v-show="showHide">
              <img src="../../assets/images/changshun/page21_1.png" alt="" />
            </div>
          </transition>
          <div class="con-one flex-cen">
            <!-- <div class="dv">
                    <transition name="bottom-top">
                      <img src="../../assets/images/changshun/page21_211.png" alt="" v-show="showHide">              
                    </transition>
                </div> -->
            <div class="dv">
              <transition name="bottom-top">
                <img
                  src="../../assets/images/changshun/page21_3.png"
                  alt=""
                  v-show="showHide"
                />
              </transition>
            ...
            <!-- <div class="dv">
                    <transition name="bottom-top">
                      <img src="../../assets/images/changshun/page21_4.png" alt="" v-show="showHide">               
                    </transition>
                </div> -->
          </div>
        </div>
...
<style scoped>
  ...
  .h2{width:2792px;height: 334px;position: relative;}
  .h3{margin-top:137px;}
  ...
  .dv{margin-top: 54px;}
  .dv:nth-child(n+2){margin-left: 19px;}
  .dv:nth-child(1) img{transition-delay: .2s}
  .dv:nth-child(2) img{transition-delay: .4s}
  .dv:nth-child(3) img{transition-delay: .6s}
  /* .dv img{width: 916px;height: 760px;} */
</style>